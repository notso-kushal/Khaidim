...
import 'package:neww/APi%20calls/7thheavenfood.dart';
...
import '../APi calls/bkingfood.dart';
import '../notifiers/wishlistnotifiers.dart';

final bkingwishlistProvider = StateNotifierProvider<Nofier, List<WishList>>((ref) => Nofier());

// ignore: must_be_immutable
class BurgerKing extends ConsumerWidget {
  BurgerKing({super.key});
                              ...
                              Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    GestureDetector(
                                      onTap: () {
                                        final wishListNotifier = ref.read(bkingwishlistProvider.notifier);
                                        final wishList = ref.read(bkingwishlistProvider);
                                        final item = WishList(
                                      ...
                                      child: Icon(
                                        ref.watch(bkingwishlistProvider).contains(
                                                  WishList(
                                                      price: filteredData[index]['price'],
                                                      rating: '$rating',
                                                      title: filteredData[index]['title'],
