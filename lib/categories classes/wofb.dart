...
import 'package:neww/APi%20calls/worldofbbeer.dart';
...
final worldofbwishlistProvider = StateNotifierProvider<Nofier, List<WishList>>((ref) => Nofier());

// ignore: must_be_immutable
class WorldofB extends ConsumerWidget {
  WorldofB({super.key});
                              ...
                              Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    GestureDetector(
                                      onTap: () {
                                        final wishListNotifier = ref.read(worldofbwishlistProvider.notifier);
                                        final wishList = ref.read(worldofbwishlistProvider);
                                        final item = WishList(
                                      ...
                                      child: Icon(
                                        ref.watch(worldofbwishlistProvider).contains(
                                                  WishList(
                                                      price: filteredData[index]['price'],
                                                      rating: '$rating',
                                                      title: filteredData[index]['title'],
