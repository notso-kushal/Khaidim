...
import 'package:neww/APi%20calls/italianFoods.dart';
...
final itawishlistProvider = StateNotifierProvider<Nofier, List<WishList>>((ref) => Nofier());

// ignore: must_be_immutable
class Italian extends ConsumerWidget {
  Italian({super.key});
                              ...
                              Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    GestureDetector(
                                      onTap: () {
                                        final wishListNotifier = ref.read(itawishlistProvider.notifier);
                                        final wishList = ref.read(itawishlistProvider);
                                        final item = WishList(
                                      ...
                                      child: Icon(
                                        ref.watch(itawishlistProvider).contains(
                                                  WishList(
                                                      price: filteredData[index]['price'],
                                                      rating: '$rating',
                                                      title: filteredData[index]['title'],
