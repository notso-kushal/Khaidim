...
import 'package:neww/APi%20calls/sluttyveganfood.dart';
...
final sluttywishlistProvider = StateNotifierProvider<Nofier, List<WishList>>((ref) => Nofier());

// ignore: must_be_immutable
class SluttyVegan extends ConsumerWidget {
  SluttyVegan({super.key});
                              ...
                              Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    GestureDetector(
                                      onTap: () {
                                        final wishListNotifier = ref.read(sluttywishlistProvider.notifier);
                                        final wishList = ref.read(sluttywishlistProvider);
                                        final item = WishList(
                                      ...
                                      child: Icon(
                                        ref.watch(sluttywishlistProvider).contains(
                                                  WishList(
                                                      price: filteredData[index]['price'],
                                                      rating: '$rating',
                                                      title: filteredData[index]['title'],
