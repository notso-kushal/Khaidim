...
import 'package:neww/APi%20calls/pizzahutfood.dart';
...
final phutwishlistProvider = StateNotifierProvider<Nofier, List<WishList>>((ref) => Nofier());

// ignore: must_be_immutable
class Pizzahut extends ConsumerWidget {
  Pizzahut({super.key});
                              ...
                              Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    GestureDetector(
                                      onTap: () {
                                        final wishListNotifier = ref.read(phutwishlistProvider.notifier);
                                        final wishList = ref.read(phutwishlistProvider);
                                        final item = WishList(
                                      ...
                                      child: Icon(
                                        ref.watch(phutwishlistProvider).contains(
                                                  WishList(
                                                      price: filteredData[index]['price'],
                                                      rating: '$rating',
                                                      title: filteredData[index]['title'],
