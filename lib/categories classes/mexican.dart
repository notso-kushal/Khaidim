...
import 'package:neww/APi%20calls/mexicanFoods.dart';
...
final mexiwishlistProvider = StateNotifierProvider<Nofier, List<WishList>>((ref) => Nofier());

// ignore: must_be_immutable
class Mexican extends ConsumerWidget {
  Mexican({super.key});
                              ...
                              Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    GestureDetector(
                                      onTap: () {
                                        final wishListNotifier = ref.read(mexiwishlistProvider.notifier);
                                        final wishList = ref.read(mexiwishlistProvider);
                                        final item = WishList(
                                      ...
                                      child: Icon(
                                        ref.watch(mexiwishlistProvider).contains(
                                                  WishList(
                                                      price: filteredData[index]['price'],
                                                      rating: '$rating',
                                                      title: filteredData[index]['title'],
