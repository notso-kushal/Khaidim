...
final sheawishlistProvider = StateNotifierProvider<Nofier, List<WishList>>((ref) => Nofier());

// ignore: must_be_immutable
class Sheaven extends ConsumerWidget {
  Sheaven({super.key});
                              ...
                              Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    GestureDetector(
                                      onTap: () {
                                        final wishListNotifier = ref.read(sheawishlistProvider.notifier);
                                        final wishList = ref.read(sheawishlistProvider);
                                        final item = WishList(
                                      ...
                                      child: Icon(
                                        ref.watch(sheawishlistProvider).contains(
                                                  WishList(
                                                      price: filteredData[index]['price'],
                                                      rating: '$rating',
                                                      title: filteredData[index]['title'],
