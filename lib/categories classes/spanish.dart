...
import 'package:neww/APi%20calls/spanishFoods.dart';
...
final spawishlistProvider = StateNotifierProvider<Nofier, List<WishList>>((ref) => Nofier());

// ignore: must_be_immutable
class Spanish extends ConsumerWidget {
  Spanish({super.key});
                              ...
                              Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    GestureDetector(
                                      onTap: () {
                                        final wishListNotifier = ref.read(spawishlistProvider.notifier);
                                        final wishList = ref.read(spawishlistProvider);
                                        final item = WishList(
                                      ...
                                      child: Icon(
                                        ref.watch(spawishlistProvider).contains(
                                                  WishList(
                                                      price: filteredData[index]['price'],
                                                      rating: '$rating',
                                                      title: filteredData[index]['title'],
