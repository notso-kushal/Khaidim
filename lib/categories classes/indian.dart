...
import 'package:neww/APi%20calls/indianFoods.dart';
...
final indwishlistProvider = StateNotifierProvider<Nofier, List<WishList>>((ref) => Nofier());
                              ...
                              Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    GestureDetector(
                                      onTap: () {
                                        final wishListNotifier = ref.read(indwishlistProvider.notifier);
                                        final wishList = ref.read(indwishlistProvider);
                                        final item = WishList(
                                      ...
                                      child: Icon(
                                        ref.watch(indwishlistProvider).contains(
                                                  WishList(
                                                      price: filteredData[index]['price'],
                                                      rating: '$rating',
                                                      title: filteredData[index]['title'],
